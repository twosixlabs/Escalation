...
with open(submission_template_filename, 'w') as fout:
    ...
    fout.write("# MODEL USED/ NOTES\n")
    fout.write("# Data schema: <11 character hash of state type=str>, <run# type=int>, <truncated 5 decimal places type=float>,<truncated 5 decimal places type=float>, <1-4 type=int>, <0-1 (confidence) type=float\n")
